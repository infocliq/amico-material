...
import { Route as AuthenticatedStagingIndexRouteImport } from './routes/_authenticated/staging/index'
...
const AuthenticatedStagingIndexRoute =
  AuthenticatedStagingIndexRouteImport.update({
    id: '/staging/',
    path: '/staging/',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any)
...
const AuthenticatedChecklistCreateRoute =
  AuthenticatedChecklistCreateRouteImport.update({
    id: '/checklist/create',
...
const AuthenticatedChecklistIdEditRoute =
  AuthenticatedChecklistIdEditRouteImport.update({
    id: '/checklist/$id/edit',
...
export interface FileRoutesByFullPath {
  ...
  '/checklist/create': typeof AuthenticatedChecklistCreateRoute
  ...
  '/staging/': typeof AuthenticatedStagingIndexRoute
...
export interface FileRoutesById {
  ...
  '/_authenticated/checklist/create': typeof AuthenticatedChecklistCreateRoute
  ...
  '/_authenticated/staging/': typeof AuthenticatedStagingIndexRoute
...
export interface FileRouteTypes {
  ...
  id:
    ...
    | '/(errors)/503'
    | '/_authenticated/'
    | '/_authenticated/checklist/create'
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/staging/': {
      id: '/_authenticated/staging/'
      path: '/staging'
      fullPath: '/staging/'
      preLoaderRoute: typeof AuthenticatedStagingIndexRouteImport
      parentRoute: typeof AuthenticatedRouteRoute
    }
    '/_authenticated/settings/': {
      id: '/_authenticated/settings/'
    ...
    '/_authenticated/checklist/create': {
      id: '/_authenticated/checklist/create'
      path: '/checklist/create'
      fullPath: '/checklist/create'
    ...
    '/_authenticated/checklist/$id/': {
      ...
      preLoaderRoute: typeof AuthenticatedChecklistIdIndexRouteImport
      parentRoute: typeof AuthenticatedRouteRoute
    }
    '/_authenticated/projects/$projectId/edit': {
    ...
    '/_authenticated/checklist/$id/edit': {
      id: '/_authenticated/checklist/$id/edit'
      path: '/checklist/$id/edit'
      fullPath: '/checklist/$id/edit'
      preLoaderRoute: typeof AuthenticatedChecklistIdEditRouteImport
      parentRoute: typeof AuthenticatedRouteRoute
    }
  }
}
...
interface AuthenticatedRouteRouteChildren {
  ...
  AuthenticatedChecklistCreateRoute: typeof AuthenticatedChecklistCreateRoute
...
const AuthenticatedRouteRouteChildren: AuthenticatedRouteRouteChildren = {
  ...
  AuthenticatedChecklistCreateRoute: AuthenticatedChecklistCreateRoute,
